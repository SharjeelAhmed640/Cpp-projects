...
int main()
{
    ...
    cout <<endl << "Enter:" << endl
        ...
        case 1:
            ...
            cin >> data;
            insert_front(&head, data); // insert data at the head
            break;

        case 2:
            cout << "Enter data value : ";
            cin >> data;
            insert_end(&head, data); // Insert data as last node
            break;

        case 3:
            cout << "Enter data value : ";
            cin >> data;
            insert_After(head->next, data); // Insert data, after previous nodes data.
            break;
        ...
        case 4:
            ...
            cout << "Enter position : ";
            cin >> position;
            insertPos(&head, position, data); //insert data at nth position
            break;

        case 5:
            cout << "Enter position : ";
            cin >> position;
            deleteNodeAtGivenPos(&head, position); //deleting node at nth position
            break;
        ...
        case 6:
            ...
            cout << "Enter position : ";
            cin >> position;
            update(&head, position, data); //updating data of nth node

        case 7:
            cout << "Doubly linked list is as follows: " << endl;
            displayList(head); //display full dll
            break;
